...
public class MemberController extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        /** 建立一個新的會員物件 */
        Member m = new Member(email, password, last_name, first_name, phone,birthday);

        /** 後端檢查是否有欄位為空值，若有則回傳錯誤訊息 */
        if(email.isEmpty() || password.isEmpty() || last_name.isEmpty()|| first_name.isEmpty()|| phone.isEmpty()|| birthday.isEmpty()) {
            /** 以字串組出JSON格式之資料 */
    ...
    public void doPut(HttpServletRequest request, HttpServletResponse response)
        ...
        Member m = new Member(id, email, password, last_name,first_name, phone,birthday);
