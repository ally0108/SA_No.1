...
-- Schema sa_database
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `sa_database` DEFAULT CHARACTER SET utf8 ;
USE `sa_database` ;

-- -----------------------------------------------------
-- Table `sa_database`.`member`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sa_database`.`member` (
...
-- -----------------------------------------------------
-- Table `sa_database`.`airport`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sa_database`.`airport` (
...
-- -----------------------------------------------------
-- Table `sa_database`.`plane`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sa_database`.`plane` (
  ...
  CONSTRAINT `depart_name`
    ...
    REFERENCES `sa_database`.`airport` (`airport_name`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `sa_database`.`order`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sa_database`.`order` (
...
-- -----------------------------------------------------
-- Table `sa_database`.`seat`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sa_database`.`seat` (
...
-- -----------------------------------------------------
-- Table `sa_database`.`ticket`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sa_database`.`ticket` (
  ...
  CONSTRAINT `order`
    ...
    REFERENCES `sa_database`.`order` (`order_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `seat`
    FOREIGN KEY (`seat_no`)
    REFERENCES `sa_database`.`seat` (`seat_no`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `plane`
    FOREIGN KEY (`plane_no`)
    REFERENCES `sa_database`.`plane` (`plane_no`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `depart_name`
    FOREIGN KEY (`departure_airport`)
    REFERENCES `sa_database`.`plane` (`departure_airport`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `arrive_name`
    FOREIGN KEY (`arrive_airport`)
    REFERENCES `sa_database`.`plane` (`arrive_airport`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `sa_database`.`Plane_Seat`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sa_database`.`Plane_Seat` (
  `seat_no` CHAR(4) NOT NULL,
  `plane_no` CHAR(50) NOT NULL,
